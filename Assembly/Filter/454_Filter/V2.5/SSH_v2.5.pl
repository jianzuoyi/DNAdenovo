...
OPTIONS:
	...
	-remove_CS <str>	parameters for HOME/bin/remove_CS.pl, default -remove_CS=\"-cat yes -remove yes -para 500\";
	...
	#	-s <int>  filter reads with length shorter than this threshold value, default no filter.
...
EXAMPLE:
	...
	perl $0 -l sff_lst -p A1
	perl $0 -l sff_lst -p A1 -sff2xxx=\"-s -q -f\"
	perl $0 -l sff_lst -p A1 -sff2xxx=\"-s -q -f\" -fas=\"-Q 30 -B 30\";
";
##====================##
##    get  options    ##
##====================##
...
$sff2xxx   ||= "-s -q";
$remove_CS ||= "-cat yes -remove yes -para 500";
$fas       ||= "-Q 20 -B 40 -w 20 -s 0";
$fa2fq     ||= "-manner Sanger";
$Project   ||= 'SSH';
##====================##
## preparing working  ##
