...
print OUT "gunzip -c @input_files | jellyfish count -m $K -o $Prefix --timing $Time_file -s $Hash_size -t $T -c 8 -C /dev/fd/0 1>$log_file 2>$error_file\n";
...
print OUT "perl $Bin/bin/kmeranalysis.pl -k $K $Prefix";
close OUT;
